...
- Display Lg: 72/72, font-serif, semibold — milestone / yearbook hero
- Display Md: 48/52, font-serif, semibold — 홈 hero, /pet 패스포트
- Display Sm: 32/36, font-serif, semibold — landing hero, onboarding reveal
...
4px grid. 화면 좌우 padding: 16px(모바일), 24px(데스크톱). 섹션 간격 기본 24px, 주제 전환 시 32–40px.
...
- v0.3 — 2026-05-03 — Hero/display typography tokens (display-sm/md/lg) + Memory Album direction (paper grain, mini-thumb mosaic, ShutterReveal ritual, monumental serif hero, onboarding deck-builder, public mosaic).
